...
print "MAS Status: " + min_active_server_status.__str__()
print "MAS Num: " + min_active_server_num.__str__()
...
for member in result_list["service_group_stat"]["member_stat_list"]:
    ...
    # print json.dumps(result_server_list)
...
# print up_port_count.__str__() + " server ports are UP"
